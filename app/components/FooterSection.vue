...
<template>
  <footer class="py-12 bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800">
      ...
      <div class="grid md:grid-cols-3 gap-8 items-center">
        ...
        <div class="flex justify-center gap-6">
          <a 
            ...
            class="w-10 h-10 flex items-center justify-center rounded-full bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-300 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white transition-all"
        ...
        <div class="text-center md:text-right">
          ...
          <p class="text-slate-400 dark:text-slate-500 text-sm">
            © {{ currentYear }} {{ profile?.name || 'Vicente Estay' }}
          </p>
        </div>
      </div>
    </div>
