...
const softSkills = [
  {
    name: 'Trabajo en equipo', color: '#3b82f6',
  ...
  {
    name: 'Resolución de problemas', color: '#8b5cf6',
  ...
  {
    name: 'Mantenimiento TI', color: '#f59e0b',
...
const learning: LearningItem[] = [
  {
    ...
    description: 'LLMs, embeddings y modelos generativos aplicados a productos reales.',
    color: '#6366f1',
  ...
  {
    name: 'Agentes IA',
    description: 'Diseño de agentes autónomos con herramientas, memoria y razonamiento multi-paso.',
    color: '#8b5cf6',
    svg: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 19.5V21M12 3v1.5m0 15V21m3.75-18v1.5m0 15V21m-9-1.5h10.5a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25H6.75A2.25 2.25 0 004.5 6.75v10.5a2.25 2.25 0 002.25 2.25zm.75-12h9v9h-9v-9z" /></svg>',
  },
  {
    name: 'RAG',
    description: 'Retrieval-Augmented Generation: búsqueda semántica y vectores para enriquecer respuestas de LLMs.',
    color: '#0ea5e9',
    svg: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" /></svg>',
  },
  {
    name: 'Ciberseguridad',
    description: 'Fundamentos de seguridad ofensiva y defensiva, análisis de vulnerabilidades y hardening.',
    color: '#ef4444',
    ...
    <div class="max-w-5xl mx-auto px-6 relative z-10">
      ...
      <div class="text-center mb-12">
        ...
        <h2 class="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4">
          <SplitText text="Stack Técnico" :visible="isVisible" :delay="100" />
        </h2>
        <p
      ...
      <div>
        ...
        >
          ...
          <span class="flex items-center gap-1.5 px-2.5 py-1 bg-emerald-50 dark:bg-emerald-500/10 rounded-full">
            ...
            <span class="text-[10px] font-semibold text-emerald-600 dark:text-emerald-400 tracking-wider uppercase">En curso</span>
          </span>
        </div>
